...
class GameKeywordDummySource {
  static final $ = AutoDisposeProvider<GameKeywordDummySource>((ref) {
    return GameKeywordDummySource();
  });

  List<GameKeyword> all = const [
    /// Animal
    ...
    GameKeyword(category: GameCategory.animal, ko: "펭귄", en: "Penguin"),
    GameKeyword(category: GameCategory.animal, ko: "고래", en: "Whale"),
    GameKeyword(category: GameCategory.animal, ko: "돌고래", en: "Dolphin"),
    ...
    GameKeyword(category: GameCategory.animal, ko: "판다", en: "Panda"),
