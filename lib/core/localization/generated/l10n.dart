...
class S {
  ...
  /// `그림을 생성하고 있어요..`
  String get sketchLoadingMessage {
    return Intl.message(
      '그림을 생성하고 있어요..',
      name: 'sketchLoadingMessage',
      desc: '',
      args: [],
    );
  }
  ...
  /// `스케치를 완성했나요?`
  String get sketchConfirmDialogTitle {
    return Intl.message(
      '스케치를 완성했나요?',
      name: 'sketchConfirmDialogTitle',
      desc: '',
      args: [],
    );
  }
  ...
  /// `스케치를 완성해 주세요`
  String get pleaseCompleteTheSketch {
    return Intl.message(
      '스케치를 완성해 주세요',
      name: 'pleaseCompleteTheSketch',
      desc: '',
      args: [],
    );
  }
  ...
  /// `스케치 스파이\n👉 초대 코드 : {roomId}`
  String inviteMessage(Object roomId) {
    return Intl.message(
      '스케치 스파이\n👉 초대 코드 : $roomId',
      name: 'inviteMessage',
      desc: '',
  ...
  /// `시간 제한`
  String get drawingSecLimit {
    return Intl.message(
      '시간 제한',
      name: 'drawingSecLimit',
      desc: '',
      args: [],
    );
  }
  ...
  /// `획 수 제한`
  String get drawingStrokeLimit {
    return Intl.message(
      '획 수 제한',
      name: 'drawingStrokeLimit',
      desc: '',
      args: [],
    );
  }
  ...
  /// `스파이 "{spy}"님이 키워드를 맞혔어요! 🕵🏻`
  String spyWinByAnsweringAction(Object spy) {
    return Intl.message(
      '스파이 "$spy"님이 키워드를 맞혔어요! 🕵🏻',
      name: 'spyWinByAnsweringAction',
      desc: '',
      args: [spy],
    );
  }
  ...
  /// `스파이 승리! 🎉`
  String get spyWinByAnsweringResult {
    return Intl.message(
      '스파이 승리! 🎉',
      name: 'spyWinByAnsweringResult',
      desc: '',
      args: [],
    );
  }

  /// `아쉽게도 "{citizen}"님은 시민입니다 🥹`
  String spyWinBySingleCitizenVoted(Object citizen) {
    return Intl.message(
      '아쉽게도 "$citizen"님은 시민입니다 🥹',
      name: 'spyWinBySingleCitizenVoted',
      desc: '',
      args: [citizen],
    );
  }

  /// `시민들이 스파이 "{spy}"님을 찾지 못했습니다 🥹`
  String spyWinByMultiCitizenVoted(Object spy) {
    return Intl.message(
      '시민들이 스파이 "$spy"님을 찾지 못했습니다 🥹',
      name: 'spyWinByMultiCitizenVoted',
      desc: '',
      args: [spy],
    );
  }
  ...
  /// `스파이 승리! 🎉`
  String get spyWinByVotingResult {
    return Intl.message(
      '스파이 승리! 🎉',
      name: 'spyWinByVotingResult',
      desc: '',
      args: [],
    );
  }
  ...
  String citizenWinAction(Object spy, Object spyKeyword) {
    return Intl.message(
      '스파이 "$spy"님이 입력한 "$spyKeyword"는 키워드가 아닙니다 🚨',
      name: 'citizenWinAction',
      desc: '',
      args: [spy, spyKeyword],
    );
  }
  ...
  /// `시민 승리! 🎉`
  String get citizenWinResult {
    return Intl.message(
      '시민 승리! 🎉',
      name: 'citizenWinResult',
      desc: '',
      args: [],
    );
  }
  ...
  String gameAnsweringSpyTitle(Object category) {
    return Intl.message(
      '당신이 스파이로 지목되었습니다.\n[$category] 카테고리의 키워드를 맞혀 보세요!',
      name: 'gameAnsweringSpyTitle',
      desc: '',
      args: [category],
    );
  }

  /// `스파이 "{spy}"님이 지목되었습니다. 스파이가 키워드를 입력하고 있어요.`
  String gameAnsweringCitizenTitle(Object spy) {
    return Intl.message(
      '스파이 "$spy"님이 지목되었습니다. 스파이가 키워드를 입력하고 있어요.',
      name: 'gameAnsweringCitizenTitle',
      desc: '',
      args: [spy],
    );
  }
  ...
  /// `키워드를 맞히면 스파이가 승리합니다.`
  String get gameAnsweringDesc {
    return Intl.message(
      '키워드를 맞히면 스파이가 승리합니다.',
      name: 'gameAnsweringDesc',
      desc: '',
      args: [],
    );
  }
  ...
  /// `키워드를 입력해 주세요.`
  String get gameAnsweringSpyInputHint {
    return Intl.message(
      '키워드를 입력해 주세요.',
      name: 'gameAnsweringSpyInputHint',
      desc: '',
      args: [],
    );
  }

  /// `{spy}님이 키워드를 입력하고 있어요..`
  String gameAnsweringCitizenInputHint(Object spy) {
    return Intl.message(
      '$spy님이 키워드를 입력하고 있어요..',
      name: 'gameAnsweringCitizenInputHint',
      desc: '',
      args: [spy],
    );
  }
  ...
  /// `{nickname}님이 그리는 중...`
  String otherPlayerTurn(Object nickname) {
    return Intl.message(
      '$nickname님이 그리는 중...',
  ...
  String get playRequirements {
    return Intl.message(
      '게임을 시작하려면 최소 3명 이상 플레이어가 필요합니다.',
      name: 'playRequirements',
      desc: '',
      args: [],
    );
  }
